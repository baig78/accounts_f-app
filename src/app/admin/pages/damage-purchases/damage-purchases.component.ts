...
@Component({
  selector: 'app-damage-purchases',
  templateUrl: './damage-purchases.component.html',
  styleUrls: ['./damage-purchases.component.scss']
})
export class DamagePurchasesComponent implements OnInit {
